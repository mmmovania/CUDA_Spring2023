...
int main(int argc, char **argv)
{
    ...
    err = clEnqueueWriteBuffer(queue, a_mem_obj, CL_TRUE, 0, N * sizeof(int), a,
                               0, NULL, NULL);
    err |= clEnqueueWriteBuffer(queue, b_mem_obj, CL_TRUE, 0, N * sizeof(int),
                                b, 0, NULL, NULL);
    ...
    err = clEnqueueNDRangeKernel(
        queue, kernel, 1, NULL, (const size_t **)&global_item_size,
    ...
    err = clEnqueueReadBuffer(queue, c_mem_obj, CL_TRUE, 0, sizeof(int) * N, c,
                              0, NULL, NULL);
